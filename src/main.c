...
/*   Updated: 2022/06/10 20:22:19 by eschirni         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	main(int argc, char **argv) //reorganize into smaller functions
{
	// t_data			*data;
	t_map			*map;
	// mlx_image_t		*img;
	...
	// img = mlx_texture_to_image(data->mlx, zomb);
	// mlx_image_to_window(data->mlx, img, 0, 0);   // Adds an image to the render queue.
